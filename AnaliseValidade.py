...
def analisar_validade(dados_validade):
    ...
    Args:
        dados_validade (str): Uma string contendo informações sobre produtos,
                               lotes, datas de validade e estoques.

    Returns:
        str: Uma análise concisa dos dados de validade, identificando padrões
             e insights sobre produtos próximos ao vencimento ou com grande
             estoque perto da data de validade.
    """
    prompt = f"""
